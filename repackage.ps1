...
nuget pack .\src\Punfai.Report.Ibex\Punfai.Report.Ibex.csproj -Build -properties Configuration=Release

Write-Host -ForegroundColor Cyan "Wpf..."
nuget pack .\src\Punfai.Report.Wpf\Punfai.Report.Wpf.csproj -Build -properties Configuration=Release -symbols
