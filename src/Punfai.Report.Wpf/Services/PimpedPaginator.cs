...
namespace Punfai.Report.Wpf.Services
{
    ...
    public class PimpedPaginator : DocumentPaginator
    {
        ...
        private Visual CreateHeaderFooterVisual(DrawHeaderFooter draw, Rect bounds, int pageNumber)
        {
            ...
            {
                draw(context, bounds, pageNumber, this.paginator.PageCount);
            }
            return visual;
        }
        ...
        public class Definition
        {
            ...
            private bool _RepeatTableHeaders = false;
        ...
        public delegate void DrawHeaderFooter(DrawingContext context, Rect bounds, int pageNr, int pageCount);
