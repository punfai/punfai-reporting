...
namespace Punfai.Report.OfficeOpenXml.Template
{
    ...
    /// </summary>
    public class WordTemplate : ITemplate
    {
        ...
        public WordTemplate(byte[] templateBytes)
        {
        ...
        /// Updates the SectionNames array to reflect the available parts.
        /// There are more parts in here... how deep do you want to go?
        /// </summary>
